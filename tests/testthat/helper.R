# Setup and return a MAGEMin calc
Minimize_ATAC4 <- function(...){
...
# Setup and return a solidus calc
Solidus_ATAC4 <- function(...){
...
# Setup and return a lower boundary calc
LBound_ATAC4 <- function(...){
  ...
  out <- findLowerStability(...)

  # Phase Proportions
  return(out)
}

# Setup and return an upper boundary calc
UBound_ATAC4 <- function(...){
  ...
  out <- findUpperStability(...)

  # Phase Proportions
  return(out)
}

# Setup and return a liquidus calc
Liquidus_ATAC4 <- function(...){
