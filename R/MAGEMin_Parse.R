...
JuliaStructToList <- function(julia_object){
  #' Convert a julia struct to a list
  #'
  #' @description
    #' Ancillary function to convert a complex julia struct to a R list.
    #' Mostly called by [MAGEMin()], but it could be used to parse sub-items
    #' of the MAGEMin struct.
  #'
...
getPhProp <- function(MMo){
  #' Get phases propoportions
  #'
  #' @description
    #' Extract the (wt%) proportions of each stable phase (pure or solid solution)
    #' from a MAGEMin object.
  #'
